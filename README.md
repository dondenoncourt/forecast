...
The user requests and address with the same zip code within a 30 minute window, and cached data is used and the forecast API is not invoked

![Backend used cached Forecast data](/public/forecast-UI-used-cache.png)

Code Coverage was implemented and here's a sample report:
